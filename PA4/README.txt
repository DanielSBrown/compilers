...
in PA4Start/ there will be the makefile to make everything.
Also in PA4Start/ is a tests/ folder that contains the test files for this assignment. the ones that have "_incorrect" should fail when trying to compile with lookupInnermost
