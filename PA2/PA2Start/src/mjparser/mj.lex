...
{DIGIT}+         {return new Symbol(Integer.parseInt(yytext()), new SymbolValue(yyline +1, yychar+1, yytext()));}
{LETTER}+    {return new Symbol(sym.PLUS, new SymbolValue(yyline +1, yychar+1, yytext()));}
